...
<body>
    ...
    <div class="centersetting">
        ...
        <input type="text" id="txt" name="userName" placeholder="Name"><br>
        <input type="text" id="txt" name="userID" placeholder="ID"><br>
        <input type="text" id="txt" name="userPassword" placeholder="Password"><br>
